...
namespace TourManagementApi.Migrations
{
    ...
    [Migration("20250617143254_AddMissingJsonColumns")]
    partial class AddMissingJsonColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TourManagementApi.Models.Activity", b =>
                {
                    ...
                    b.OwnsMany("TourManagementApi.Models.ViewModels.GuestFieldsViewModel+GuestField", "GuestFields", b1 =>
                        {
                            b1.Property<int>("ActivityId")
                                .HasColumnType("int");
                            ...
                            b1.OwnsMany("TourManagementApi.Models.ViewModels.GuestFieldsViewModel+GuestFieldOption", "Options", b2 =>
                                {
                                    ...
                                    b2.HasAnnotation("Relational:JsonPropertyName", "options");

                                    b2.WithOwner()
                                        .HasForeignKey("GuestFieldActivityId", "GuestFieldId");

                                    b2.OwnsMany("TourManagementApi.Models.ViewModels.GuestFieldsViewModel+GuestFieldOptionTranslation", "Translations", b3 =>
                                        {
                                            ...
                                            b3.HasAnnotation("Relational:JsonPropertyName", "translations");
                            ...
                            b1.OwnsMany("TourManagementApi.Models.ViewModels.GuestFieldsViewModel+GuestFieldTranslation", "Translations", b2 =>
                                {
                                    b2.Property<int>("GuestFieldActivityId")
                                        .HasColumnType("int");
                                    ...
                                    b2.HasAnnotation("Relational:JsonPropertyName", "translations");
