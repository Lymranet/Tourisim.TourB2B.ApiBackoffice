namespace TourManagementApi.Models.Api.Rezdy
{
    public class BookingRequest
    {
        ...
        public List<BookingRequestItems> Items { get; set; }
    ...
    public class BookingRequestCustomer
    {
        ...
        public string Title { get; set; } // "Miss" "Mr." "Mrs." "Ms."
    }
    ...
    public class BookingRequestCreditCard
    {
        ...
        public string CardType { get; set; } // AMEX, VISA, etc.
        public string ExpiryMonth { get; set; } // "01" - "12"
        public string ExpiryYear { get; set; } // "2025" etc.
    ...
    public class BookingRequestItems
    {
        ...
        public int? TotalItemTax { get; set; }
    ...
    {
        public float Amount { get; set; } // required
        public string Type { get; set; } // required: "CREDITCARD", "PAYPAL", etc.

        public string Currency { get; set; } // optional: "USD", "EUR", etc.
        public string Date { get; set; }     // optional: işlem tarihi
        public string Label { get; set; }    // optional: işlem referansı
        public string Recipient { get; set; } // optional: "SUPPLIER", "REZDY", "RESELLER"
    }
